...
ActiveRecord::Schema.define(version: 2020_02_15_160238) do
  ...
  create_table "tickets", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "consultation_id"
    t.index ["consultation_id"], name: "index_tickets_on_consultation_id"
  end
  ...
  add_foreign_key "tickets", "consultations"
